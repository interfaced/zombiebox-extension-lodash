const lodash = {
	 ...
	 * @return {Array} Returns the new array of intersecting values.
	 */
	intersectionBy: function (arrays0, arrays1, iteratee) {
	},
	/**
	 ...
	 * @return {Array} Returns the new array of intersecting values.
	 */
	intersectionWith: function (arrays0, arrays1, comparator) {
	},
	/**
	 ...
	 * @return {Array} Returns the new array of combined values.
	 */
	unionBy: function (arrays0, arrays1, iteratee) {
	},
	/**
	 ...
	 * @return {Array} Returns the new array of combined values.
	 */
	unionWith: function (arrays0, arrays1, comparator) {
	},
	/**
	 ...
	 * @return {Array} Returns the new array of filtered values.
	 */
	xorBy: function (arrays0, arrays1, iteratee) {
	},
	/**
	 ...
	 * @return {Array} Returns the new array of filtered values.
	 */
	xorWith: function (arrays0, arrays1, comparator) {
	},
	/**
	 ...
	 * @return {Array} Returns the new array of grouped elements.
	 */
	zipWith: function (arrays0, arrays1, iteratee) {
	},
	/**
	 ...
	 * @return {Array} Returns the new flattened array.
	 */
	flatMapDepth: function (collection, iteratee, depth) {
	},
	/**
	 ...
	 * @param {number=} arity The arity of `func`.
	 */
	curryRight: function (func, arity) {
	},
	/**
